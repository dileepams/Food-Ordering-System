    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Juice Life | Online Burger Ordering System <br> <a href="http://localhost/fos/admin">Admin Login</a></div></div>
        </footer>
